      ...
      <div className='result-history-timeline-container'>
        <div className='result-history-timeline-user1-container'>
          ...
          {props.apiList.map(film => (
            <div className={props.user1List.includes(film) ? (props.matchList.includes(film) ? 'timeline-movie-container validated matched' : 'timeline-movie-container validated') : 'timeline-movie-container rejected'} key={film.id}>
              <div
        ...
        <div className='result-history-timeline-user2-container'>
          <h4>{props.user2}</h4>
          {props.apiList.map(film => (
            <div className={props.user2List.includes(film) ? 'timeline-movie-container validated' : 'timeline-movie-container rejected'} key={film.id}>
              <div
